OC.L10N.register(
    ...
    "Approve" : "Cheadaigh",
    "Cancel" : "Cealaigh",
    "Login attempt from IP address {ip}" : "Iarracht logáil isteach ón seoladh IP {ip}",
    "If you are currently trying log in from another device or browser please approve the request. If you are not trying to log in at the moment, you should use the cancel option to abort the login attempt." : "Má tá tú ag iarraidh logáil isteach ó ghléas nó bhrabhsálaí eile faoi láthair, ceadaigh an t-iarratas. Mura bhfuil tú ag iarraidh logáil isteach faoi láthair, ba cheart duit an rogha cealaithe a úsáid chun deireadh a chur leis an iarracht logáil isteach.",
