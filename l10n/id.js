OC.L10N.register(
    ...
    "Approve" : "Menyetujui",
    "Cancel" : "Membatalkan",
    "Login attempt from IP address {ip}" : "Upaya login dari alamat IP {ip}",
    "If you are currently trying log in from another device or browser please approve the request. If you are not trying to log in at the moment, you should use the cancel option to abort the login attempt." : "Jika saat ini Anda mencoba masuk dari perangkat atau browser lain, harap setujui permintaan tersebut. Jika saat ini Anda tidak mencoba masuk, Anda harus menggunakan opsi batal untuk membatalkan upaya masuk.",
