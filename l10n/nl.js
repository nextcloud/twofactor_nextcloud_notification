OC.L10N.register(
    ...
    "Approve" : "Goedkeuren",
    "Cancel" : "Annuleren",
    "Login attempt from IP address {ip}" : "Aanmeldpoging van IP-adres {ip}",
    "If you are currently trying log in from another device or browser please approve the request. If you are not trying to log in at the moment, you should use the cancel option to abort the login attempt." : "Als je zelf probeert aan te melden vanaf een ander apparaat of browser keur dan de aanvraag goed. Als je je niet probeert aan te melden, kies dan de Afbreken optie om de aanmeldpoging af te breken.",
