OC.L10N.register(
    ...
    "Approve" : "Goedkeuren",
    "Cancel" : "Annuleren",
    "Login attempt from {ip}" : "Inlog poging vanaf {ip}",
    "Please approve or cancel the login." : "De inlog goedkeuren of weigeren.",
    ...
    "TwoFactor via nextcloud notification" : "Twee-factor via Nextcloud melding",
