OC.L10N.register(
    ...
    "Approve" : "Aprovar",
    "Cancel" : "Cancelar",
    "Login attempt from {ip}" : "Tentativa de login de {ip}",
    "Please approve or cancel the login." : "Por favor, aprove ou cancele o login.",
    ...
    "TwoFactor via nextcloud notification" : "Notificação Nextcloud de dois fatores",
    ...
    "Nextcloud notification second-factor auth" : "Autenticação de segundo fator da notificação Nextcloud",
