OC.L10N.register(
    ...
    "material-design-icon loading-icon" : "material-design-ícone carregando-ícone",
    ...
    "checkbox-content__icon" : "ícone_de_conteúdo_da_caixa_de_seleção",
    "checkbox-content" : "conteúdo-da-caixa-de-seleção",
    "checkbox-radio-switch__content" : "caixa de seleção-interruptor-de-rádio__conteúdo",
    "Use two-factor authentication via Nextcloud notifications" : "Use autenticação de dois fatores via notificações do Nextcloud",
    "switch" : "trocar",
    "twofactor-notification-settings" : "configurações-de-notificação-de-dois-fatores",
