OC.L10N.register(
    ...
    {
    "TwoFactor Nextcloud notification" : "TwoFactor Nextcloud ئۇقتۇرۇشى",
    "Approve" : "تەستىق",
    "Cancel" : "ۋاز كەچ",
    "Login attempt from IP address {ip}" : "IP ئادرېسىدىن كىرىش سىنىقى {ip}",
    "If you are currently trying log in from another device or browser please approve the request. If you are not trying to log in at the moment, you should use the cancel option to abort the login attempt." : "ئەگەر ھازىر باشقا ئۈسكۈنىدىن ياكى توركۆرگۈدىن كىرمەكچى بولسىڭىز ، تەلەپنى تەستىقلاڭ. ئەگەر ھازىر كىرمەكچى بولسىڭىز ، بىكار قىلىش تاللانمىسىنى ئىشلىتىپ كىرىش سىنىقىنى ئەمەلدىن قالدۇرۇشىڭىز كېرەك.",
    "Nextcloud Notification" : "Nextcloud ئۇقتۇرۇشى",
