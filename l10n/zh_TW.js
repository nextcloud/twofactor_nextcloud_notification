OC.L10N.register(
    ...
    {
    "TwoFactor Nextcloud notification" : "Nextcloud 兩階段驗證通知",
    "Approve" : "核准",
    "Cancel" : "取消",
    "Login attempt from IP address {ip}" : "來自 IP 地址 {ip} 的登入嘗試",
    ...
    "Please accept the request on one of your logged in devices." : "請在您已登入的某個裝置上核准登入請求。",
